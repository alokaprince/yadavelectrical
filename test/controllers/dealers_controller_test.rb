...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post dealers_url, params: { dealer: { address: @dealer.address, balance: @dealer.balance, mobile: @dealer.mobile, name: @dealer.name, recieve: @dealer.recieve, total: @dealer.total } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { address: @dealer.address, balance: @dealer.balance, mobile: @dealer.mobile, name: @dealer.name, recieve: @dealer.recieve, total: @dealer.total } }
